...
async function generateComment(imageBase64, captionText) {
  const prompt =
    "Write a short, casual Instagram comment (1 sentence under 80 characters). Relate it to the image and/or caption. No hashtags. Do not use exclamation points, quotation marks or apostrophes. Keep it vague but make it intriguing. Reply with ONLY the comment.";
